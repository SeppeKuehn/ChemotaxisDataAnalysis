...
%makeFigureBlack(gca)
l = legend([hl(1),hl(2),hl(3),hl(4),hl(5),hl(6)],{'round 1','round 5','round 10','round 15','clpX','delta1bp'});
...
%l.textcolor = 'white';
set(gcf,'color','w')
export_fig([pwd,'/Output/RunDurationFounderEvolvedClpXDelta1bp '],'-png')
...
l = legend({'round 1','round 5','round 10','round 15','clpX','delta1bp'});
%set(l,'textcolor','white','fontsize',28)
xlabel('Run speed [\mum/s]','fontsize',40)
ylabel('Probability','fontsize',40)
set(gcf,'color','w')
export_fig([pwd,'/Output/RunSpeedFounderEvolvedClpXDelta1bp '],'-png')
